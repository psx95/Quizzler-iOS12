...
//  Quizzler
//
//  Created by Pranav Sharma on 26/01/19.
//  Copyright © 2019 London App Brewery. All rights reserved.
// This class stores all the questions in the app. This is the data in MVC

import Foundation

class QuestionBank {
    
    var list = [Question]() // creates a varaible sized array containing Objects of type Question.
